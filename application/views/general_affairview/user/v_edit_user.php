                ...
                <?php foreach($user as $u){
                    ...
                    <input type="hidden" class="form-control" name="nik" id="nik" value="<?php echo $u['nik']?>">
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Status</label>
                                    <div class="col-sm-3 "><div class="i-checks"><label> <input type="radio" value="Aktif" name="status" <?php if($u['status']=='Aktif') echo "checked" ?>> <i></i> Aktif </label></div>
                                    </div>
                                    <div class="col-sm-3 "><div class="i-checks"><label> <input type="radio" value="Tidak Aktif" name="status" <?php if($u['status']=='Tidak Aktif') echo "checked" ?>> <i></i>Tidak Aktif </label></div>
                                    </div>
                                </div>
                <?php } ?>
                            </form>
