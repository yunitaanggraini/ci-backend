            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-sm-10">
                            <div>
                                <div class="form-group"><label class="col-sm-4 control-label">Pencarian Berdasarkan Nama Cabang</label>
                                <div class="col-sm-8"><input type="text" class="form-control" id="Incabang"></div></div>        
                            </div>        
                        </div>
                ...
                <div class="panel panel-primary">
                    <div class="ibox-title float-e-margins">
                        <div class="form-group">
                            <label class="col-sm-3"> <h5>List Data Cabang</h5></label>
