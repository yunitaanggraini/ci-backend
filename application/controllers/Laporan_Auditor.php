...
class laporan_auditor extends CI_Controller {
    ...
    public function Laporan_Part()
        ...
        public function cetak()
        {
            ...
            $start=0;
            $cetak = $this->mlapaudit->auditPdf($cabang, $tgl_awal,$tgl_akhir,$start);
            if ($cetak !=null) {
                ...
                foreach ($cetak as $c ) {
                    ...
                    $x= $pdf->GetX();
                    $pdf->myCell(20,7,$x,$c['umur_unit']);
                    $x= $pdf->GetX();
                    $pdf->myCell(25,7,$x,$c['nama_lokasi']);
                    $x= $pdf->GetX();
        ...
        public function cetakexcel()
        {
            ...
            if ($type =='excel') {
                ...
                $pdf->Cell(190,7,'TRIO MOTOR '.$cab,0,1,'C');
                ...
                foreach ($cetak as $c ) {
                    ...
                    $pdf->Cell(25,6,$c['nama_lokasi'],1,0);
        ...
        public function cetakexcelnotready()
        {
            ...
            if ($type =='excel') {
                ...
                $style_row=[
                    ...
                    $cetak = $this->mlapaudit->cetakUnitnotready($cabang, $tgl_awal,$tgl_akhir,$is_ready);
                    ...
                    $excel->getActiveSheet(0)->setTitle($ready.$tgl);
                    $excel->setActiveSheetIndex(0);
                    header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
                    header("Content-Disposition: attachment; filename=REPORT-UNIT".$ready.$tgl.".xlsx"); // Set nama file excel nya
                    header('Cache-Control: max-age=0');
                    $write = PHPExcel_IOFactory::createWriter($excel, 'Excel2007');
                    // var_dump($write);die;
                    $write->save('php://output');
        ...
        public function prevaksesoris()
        {
            ...
            $count= $this->mlapaudit->aksesoriscount($cabang, $tgl_awal,$tgl_akhir);
            ...
            $cetak= $this->mlapaudit->prevAksesoris($cabang, $tgl_awal,$tgl_akhir,$start);
            $row_entry ='
        ...
        public function cetakperlokasi()
        {
            ...
            $start=null;
            $cetak= $this->mlapaudit->prevAksesorisPdf($cabang, $tgl_awal,$tgl_akhir,$start);
            if ($cetak !=null) {
        ...
        public function previewnotready()
        {
            ...
            if ($is_ready!=null) {
                ...
                $count= $this->mlapaudit->countunitnotready($cabang, $tgl_awal,$tgl_akhir,$is_ready);
                ...
                $cetak= $this->mlapaudit->previewUnitnotready($cabang, $tgl_awal,$tgl_akhir,$is_ready,$start);
                $row_entry ='
                    <div class=" label label-default">'.$count.'</div>
                ';
            }
        ...
        public function preview()
        {
            ...
            if ($status!=null) {
                ...
                $count= $this->mlapaudit->countunitvalid($cabang, $tgl_awal,$tgl_akhir);
                // $count= 13;
                // $this->load->library('pagination');
                $config['base_url'] = base_url().'laporan_auditor/preview';
                $config['total_rows'] = $count;
                ...
                $cetak= $this->mlapaudit->auditUnit($cabang, $tgl_awal,$tgl_akhir,$start);
                $row_entry ='
                    <div class=" label label-default">'.$count.'</div>
                ';
            }
        ...
        public function previewPart()
        {
            ...
            $this->load->library('pagination');
                ...
                $cetak= $this->mlapaudit->auditPart($cabang, $tgl_awal,$tgl_akhir,$start);
                $row_entry ='
                    <div class=" label label-default">'.$count.'</div>
                ';
        ...
        public function cetakPart()
        {
            ...
            $start=0;
            $cetak = $this->mlapaudit->partvalid($cabang, $tgl_awal,$tgl_akhir,$start);
            if ($cetak !=null) {
